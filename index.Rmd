...
However, distribution of such results to collaborators/managers remains a challenge. Interactive plots cannot be stored in pdf files.
...
[Shiny](https://shiny.rstudio.com/) was considered but
  ...
  * Cannot expect collaborators/managers to install/run R packages and code to view the results.
]
